...
class RestaurantsWidget extends StatefulWidget {
  RestaurantsWidget({Key key, this.title}) : super(key: key);
  final String title;

  @override
  RestaurantsWidgetState createState() => new RestaurantsWidgetState();
}

class RestaurantsWidgetState extends State<RestaurantsWidget> {
  ...
  ListTile restaurantsList(BuildContext context, Restaurant restaurant) {
    return ListTile(
      ...
      trailing: IconButton(
          ...
          onPressed: () {
            print('go to restaurant details page');
            // TODO: restaurant details
          }),
      onTap: () {
        print(restaurant.name);
        print('this restaurant is tapped');
      },
    );
  }
